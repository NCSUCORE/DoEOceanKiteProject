...
% Inputs
%   ChrdL  = Total chord length
%   Skmax  = Max skin thickness
%   Spmax  = Max spar thickness
%   Nspars = Number of spars

% Outputs
%   Ixx_lim    = Total MOI of skin an spar 
%   Area_skin  = Total skin area
%   Area_spars = Total spar area
...
%Spar max thicknesses based on grid
Sp1T = Spmax*200; %Max spar 1 thickness
Sp2T = Spmax*200; %Max spar 1 thickness
Sp3T = Spmax*200; %Max spar 1 thickness

%Spar locations % of total chord (center of spar)
x_w1_ori = 60; x_w2_ori = 90; x_w3_ori = 35;

%Front and back of spar locations
