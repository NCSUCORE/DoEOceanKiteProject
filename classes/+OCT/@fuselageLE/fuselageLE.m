classdef fuselageLE < handle
    ...
    methods
        %% Constructor
        function obj = fuselageLE
            obj.diameter             = SIM.parameter('Unit','m');
            obj.rNose_LE             = SIM.parameter('Unit','m','Description','Vector from the kite CM to the front of the fuselage');
            obj.rEnd_LE              = SIM.parameter('Unit','m','Description','Vector from the kite CM to the end of the fuselage');
