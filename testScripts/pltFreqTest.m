...
for j = 2:2
    for i = 2:7
        ...
        saveas(h1,sprintf('C:\\Users\\jcreed2\\GitStuff\\bubble3P0\\outputJames\\anchThrTen%d%d.png', i,j))
        saveas(h2,sprintf('C:\\Users\\jcreed2\\GitStuff\\bubble3P0\\outputJames\\gndStnPos%d%d.png', i,j))
        saveas(h3,sprintf('C:\\Users\\jcreed2\\GitStuff\\bubble3P0\\outputJames\\power%d%d.png', i,j))
        catch
        end
        % x = tsc.powerSummary;
