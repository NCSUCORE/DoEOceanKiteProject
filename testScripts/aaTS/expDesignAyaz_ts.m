...
loadComponent('Manta2RotXFoil_AR8_b8_exp_3dPrinted');                             %   Manta kite with XFoil
...
if simScenario >= 2 && simScenario < 4
            fltCtrl.LaRelevationSP.setValue(20,'deg');          fltCtrl.LaRelevationSPErr.setValue(1,'deg');        %   Elevation setpoints
...
fltCtrl.pitchSP.ki.setValue(0,'(deg)/(deg*s)')
