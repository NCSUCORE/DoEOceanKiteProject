...
%                 wnch.winch1.LaRspeed.setValue(1,'m/s');
                ...
                fltCtrl.yawMoment.kp.setValue(3,'(N*m)/(rad)')
...
figure
subplot(2,1,1)
plotsq(tsc.mDes.Time,tsc.mDes.Data(:,2),'DisplayName','Periodic')
hold on
plotsq(tsc.mDes.Time,tsc.desiredMoment.Data(1,1,:),'DisplayName','Path Following')
legend
ylabel 'Roll Moment Desired'
xlim([2 inf])
ylim([-10 10])
subplot(2,1,2)
plotsq(tsc.mDes.Time,tsc.mDes.Data(:,2),'DisplayName','Periodic')
hold on
plotsq(tsc.mDes.Time,tsc.desiredMoment.Data(2,1,:),'DisplayName','Path Following')
legend
ylabel 'Yaw Moment Desired'
xlim([2 inf])
% bMat = tsc.scaledB
% figure;
% hold on;
