...
thrSweep = 4800%[400 600 800:400:4800]%200:50:600;
...
%             tsc = tsc.resample(0:0.1:tsc.positionVec.Time(end));
            ...
            if i == 1
                filename = sprintf(strcat('ConstEl_V-%.2f_Alt-%d_thr-%d.mat'),flwSpd,altitude,thrLength);
            else
                filename = sprintf(strcat('BPConstEl_V-%.2f_Alt-%d_thr-%d.mat'),flwSpd,altitude,thrLength);            end
            if simScenario(6)
