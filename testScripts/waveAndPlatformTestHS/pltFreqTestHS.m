        ...
        for kk = 1:2
            for jj = 1:12
                for ii = 1:1
                    ...
                    clearvars -except 'Amplitudes' 'Frequencies' 'waveNumber' 'ii' 'jj' 'qq' 'powerMatSaverKiteFloatingStationHS' 'kk' 'tetherL'  'flowSpeeds' 'heights' 'pp' 'tetherDist'
                    ...
                    clearvars -except 'Amplitudes' 'Frequencies' 'waveNumber' 'ii' 'jj' 'qq' 'pp' 'powerMatSaverKiteFloatingStationHS' 'kk' 'tetherL'  'flowSpeeds' 'heights' 'tetherDist'
                    clc;close all
                    ...
                    try
                        ...
                        powerMatSaverKiteFloatingStationHS(ii,jj,kk,pp,qq) = powAvg;
                        
                       save('powerMatSaverKiteFloatingStationHS.mat','powerMatSaverKiteFloatingStationHS')
                    catch
                    end
