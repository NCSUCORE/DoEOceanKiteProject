    ...
    for j = 1:m
        ...
        for k = 1:r
            ...
            for ii = 1
                ...
                Simulink.sdi.clear
                %%  Set Test Parameters
                tFinal = 500;      tSwitch = 10000;                        %   s - maximum sim duration
                ...
                loadComponent('pathFollowingTetherFaired');                       %   Manta Ray tether
                ...
                thr.tether1.fairedLength.setValue(fairing(k),'m')
                thr.tether1.fairedLinks.setValue(max([ceil(fairing(k)/50)]),'')
                ...
                thr.numNodes.setValue(ceil((thrLength-thr.tether1.fairedLength.Value)/200)+thr.tether1.fairedLinks.Value,'');
                thr.tether1.numNodes.setValue(ceil((thrLength-thr.tether1.fairedLength.Value)/200)+thr.tether1.fairedLinks.Value,'');
                ...
                progress = sprintf('%d Thr %.1f Altitude %.2f Flow Speed %d m Fairing Path %d\n',...
                    thrLength,altitude,flwSpd,fairing(k),ii);
                fprintf(progress)
