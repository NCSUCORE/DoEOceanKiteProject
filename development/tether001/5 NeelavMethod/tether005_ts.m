...
for i = 1:Num(3)
    ...
    %shading interp
    hold off
   title(['Tether 100 (m) Reel-Out 12 m/s Current (1% Elongation) (time (s) ',num2str(round(round(Time(i),2,'significant'),4)),')'],'FontSize',12);
   %  ylim([-15,15]);
...
%     xlabel('x,(m)','FontSize',14);
   ...
   % xlabel('x,(m)','FontSize',13);
    ...
    xlabel('Horizontal tether with 10 m/s upwelling','FontSize',12);
drawnow 
