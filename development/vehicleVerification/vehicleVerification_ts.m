...
hold on
grid on
plot(tscMod.tetherLengths.Time,squeeze(tscMod.tetherLengths.Data(1,:,:)),...
    'LineWidth',1.5,'Color',[0.5 0.5 0.5],'LineStyle','--')
xlabel('Time, [s]')
...
hold on
grid on
plot(tscMod.tetherLengths.Time,squeeze(tscMod.tetherLengths.Data(2,:,:)),...
    'LineWidth',1.5,'Color',[0.5 0.5 0.5],'LineStyle','--')
xlabel('Time, [s]')
...
hold on
grid on
plot(tscMod.tetherLengths.Time,squeeze(tscMod.tetherLengths.Data(3,:,:)),...
    'LineWidth',1.5,'Color',[0.5 0.5 0.5],'LineStyle','--')
xlabel('Time, [s]')
