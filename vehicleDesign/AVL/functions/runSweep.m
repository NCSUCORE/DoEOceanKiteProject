...
dsgn_test.input_file_name = 'desRun2';
dsgn_test.result_file_name = 'resRun2';
dsgn_test.lookup_table_file_name = 'lookupFinTable2';
...
sweepCase.alpha = linspace(-20,20,n_alpha);
sweepCase.beta = linspace(-20,20,n_beta);
sweepCase.flap = linspace(0,10,n_flap);
sweepCase.aileron = linspace(-10,10,n_aileron);
sweepCase.elevator = linspace(-10,10,n_elevator);
sweepCase.rudder = linspace(-15,15,n_rudder);
