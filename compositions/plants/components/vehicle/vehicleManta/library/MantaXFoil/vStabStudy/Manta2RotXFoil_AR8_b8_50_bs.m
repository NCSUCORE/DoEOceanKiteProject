...
fName = "Manta2RotXFoil_AR8_b8_50";
fluidName = 'Manta_AR8_b8_50';
...
vhcl.setFluidCoeffsFileName(fluidName,'');
...
vStabArea = vhcl.vStab.rootChord.Value*(1+vhcl.vStab.TR.Value)/2*vhcl.vStab.halfSpan.Value*ratio(i)/100;
vhcl.vStab.setHalfSpan(sqrt(vStabArea*4),'m');
vhcl.vStab.setRootChord(2*vStabArea/(vhcl.vStab.halfSpan.Value*...
    (1+vhcl.vStab.TR.Value)),'m');
...
V = load('NACA0015_VertStab_heightchange_AR4_50pct.mat');

vhcl.vStab.setCL((V.cl_c-V.cl_c(36))*vhcl.vStab.planformArea.Value/vhcl.fluidRefArea.Value,'');
vhcl.vStab.setCD(V.CD_c*vhcl.vStab.planformArea.Value/vhcl.fluidRefArea.Value,'');
vhcl.vStab.setAlpha(V.alfa_c,'deg');
