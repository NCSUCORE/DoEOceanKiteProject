...
LIBRARY               = "Manta2RotXFoil_AR9_b10_B1pct";
...
vhcl.setBuoyFactor(1.02638359510927,''); %Should this be slightly positively buoyant?
vhcl.setFluidCoeffsFileName('Manta_AR9_b10','');
vhcl.setHydroCharacterization(2,'');
%% Volumes and Inertia
vhcl.setVolume(2.4134101,'m^3');
Ixx = 7.7863795e+03;
Iyy = 5.6890570e+03;
Izz = 1.3338598e+04;
Ixy = 1.2253506e-01;
...
%% Important Points
vhcl.setRCM_LE([8.3134090e-01;0;2.3868924e-02],'m')
...
vhcl.setRBridle_LE([vhcl.rCM_LE.Value(1)-.375;0;-vhcl.fuse.diameter.Value/2],'m');
%% Turbines
vhcl.setNumTurbines(2,'');
vhcl.build('TurbClass','turb');
% port rotor
vhcl.turb1.setMass(6,'kg')
vhcl.turb1.setDiameter(.65,'m')
...
vhcl.turb1.setStaticArea(0.075,'m^2')
vhcl.turb1.setStaticCD(1.5,'')
% starboard rotor
vhcl.turb2.setMass(6,'kg')
vhcl.turb2.setDiameter(.65,'m')
...
vhcl.turb2.setStaticArea(0.075,'m^2')
