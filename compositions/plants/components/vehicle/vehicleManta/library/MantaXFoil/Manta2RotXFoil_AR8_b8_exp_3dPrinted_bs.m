...
vhcl.setBuoyFactor(0.975,''); %Should this be slightly positively buoyant?
vhcl.setFluidCoeffsFileName('Manta_AR8_b8_exp2','');
vhcl.setHydroCharacterization(2,'');
%% Volumes and Inertia
vhcl.setVolume(3.129,'m^3');
Ixx = 10.44e+03;
Iyy = 9.53e+03;
Izz = 19.13e+03;
Ixy = 0;
...
%% Important Points
vhcl.setRCM_LE([.89;0;0],'m')
vhcl.setRB_LE([0;0;0],'m');
vhcl.setRCentOfBuoy_LE([.96;0;3.01e-02],'m');
...
%% H-stab and V-stab
vhcl.hStab.setRSurfLE_WingLEBdy([3.65;0;0],'m');
...
vhcl.vStab.setRSurfLE_WingLEBdy([3.65;0;0],'m');
...
vhcl.setRBridle_LE([0.19;0; -0.72],'m')
%% Turbines
