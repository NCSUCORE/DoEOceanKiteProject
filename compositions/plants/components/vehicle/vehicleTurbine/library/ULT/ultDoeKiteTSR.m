...
vhcl.turb1.turbInertiaStated.setValue(.4,'kg*m^2')
vhcl.turb4.turbMassStated.setValue(10,'kg')
vhcl.turb4.turbInertiaStated.setValue(.4,'kg*m^2')
vhcl.turb3.turbMassStated.setValue(10,'kg')
vhcl.turb3.turbInertiaStated.setValue(.4,'kg*m^2')
vhcl.turb2.turbMassStated.setValue(10,'kg')
vhcl.turb2.turbInertiaStated.setValue(.4,'kg*m^2')
