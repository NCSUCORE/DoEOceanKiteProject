...
vhcl.turb1.setDiameter(1,'m')
vhcl.turb1.hubDiameter.setValue(.075,'m')
vhcl.turb1.setAxisUnitVec([1;0;0],'')
vhcl.turb1.setAttachPtVec(vhcl.portWing.outlinePtsBdy.Value(:,2)*1/3+[0;0;0.6],'m')
...
vhcl.turb1.CpLookup.setValue([cp cp],'')
vhcl.turb1.CtLookup.setValue([ct ct],'')
vhcl.turb1.RPMref.setValue([1 7],'')

%portLower Rotor

vhcl.turb2.setAxisUnitVec([-1;0;0],'')
vhcl.turb2.setAttachPtVec(vhcl.portWing.outlinePtsBdy.Value(:,2)*1/3-[0;0;0.6],'m')
...
vhcl.turb2.CpLookup.setValue([cp cp],'')
vhcl.turb2.CtLookup.setValue([ct ct],'')
vhcl.turb2.RPMref.setValue([1 7],'')

vhcl.turb3.setAxisUnitVec([-1;0;0],'')
vhcl.turb3.setAttachPtVec(vhcl.stbdWing.outlinePtsBdy.Value(:,2)*1/3+[0;0;0.6],'m')
...
vhcl.turb3.CpLookup.setValue([cp cp],'')
vhcl.turb3.CtLookup.setValue([ct ct],'')
vhcl.turb3.RPMref.setValue([1 7],'')


vhcl.turb4.setAxisUnitVec([1;0;0],'')
vhcl.turb4.setAttachPtVec(vhcl.stbdWing.outlinePtsBdy.Value(:,2)*1/3-[0;0;0.6],'m')
...
vhcl.turb4.CpLookup.setValue([cp cp],'')
vhcl.turb4.CtLookup.setValue([ct ct],'')
