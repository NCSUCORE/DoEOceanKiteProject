...
load('poolKiteWingsDragScreen.mat')
vhcl.stbdWing.alpha.setValue(pKW(1,:)','deg')
vhcl.stbdWing.CL.setValue(pKW(2,:)','')
vhcl.stbdWing.CD.setValue(pKW(3,:)','')
vhcl.portWing.alpha.setValue(pKW(1,:)','deg')
vhcl.portWing.CL.setValue(pKW(2,:)','')
vhcl.portWing.CD.setValue(pKW(3,:)','')

load('poolKiteFuse.mat')
vhcl.fuse.alpha.setValue(pF(1,:)','deg')
