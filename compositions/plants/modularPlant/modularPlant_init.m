...
nom_tether_diameter = [0.055; 0.076; 0.055];
...
% chordwise tether sepatration distance
x_tet_sep = R2n_cm(1) - R1n_cm(1);
...
% store in structure
tether_imp_nodes.R1n_cm = R1n_cm;
tether_imp_nodes.R2n_cm = R2n_cm;
tether_imp_nodes.R3n_cm = R3n_cm;
tether_imp_nodes.R11_g = R11_g;
tether_imp_nodes.R21_g = R21_g;
tether_imp_nodes.R31_g = R31_g;
...
P_mat = [0.25 0.5 0.25; 0.5 -1 0.5; -1 0 1];
P_inv = inv(P_mat);

% store in structure
controller_param.winc_vel_up_lims = winc_vel_up_lims;
controller_param.alti_control = alti_control;
controller_param.pitch_control = pitch_control;
controller_param.roll_control = roll_control;
controller_param.P_inv = P_inv;
...
node_locations = intermediate_nodes(R11_g,R21_g,R31_g,R1n_cm,R2n_cm,R3n_cm,N,X0_partial);
