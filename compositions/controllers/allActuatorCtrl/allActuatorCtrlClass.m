classdef allActuatorCtrlClass < handle
    ...
    methods
        ...
        function obj = allActuatorCtrlClass()
            ...
            obj.altitudeKp               = simulinkProperty(0.05,'Unit','1/s','Description','altitude controller proportional gain');
            obj.altitudeKi               = simulinkProperty(0,'Unit','1/s^2','Description','altitude controller integral gain');
            obj.altitudeKd               = simulinkProperty(0.05,'Description','altitude derivative controller gain');
            obj.altitudeFilterTimeConst  = simulinkProperty(1/(2*pi*0.005),'Unit','s/rad','Description','altitude controller time constant');
            
            % Pitch controller gains
            obj.pitchKp              = simulinkProperty(0.75,'Unit','m/(deg*s)','Description','pitch controller proportional gain');
            ...
            obj.pitchFilterTimeConst = simulinkProperty(1/(2*pi*0.2),'Unit','s/rad','Description','pitch controller time constant');
            ...
            obj.rollFilterTimeConst = simulinkProperty(1/(2*pi*0.2),'Unit','s/rad','Description','roll controller time constant');
