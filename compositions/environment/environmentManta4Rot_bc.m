function  environmentManta4Rot_bc
...
elems(1).Dimensions = [3 15]; % Assumes 5 fluid dynamic surfaces (4 + fuselage) + 6 gradient poll positions
elems(1).DimensionsMode = 'Fixed';
elems(1).DataType = 'double';
elems(1).SampleTime = -1;
elems(1).Complexity = 'real';
...
elems(2).Dimensions = [15,1]; % Assumes 5 fluid dynamic surfaces (4 + fuselage) + 6 gradient poll positions
