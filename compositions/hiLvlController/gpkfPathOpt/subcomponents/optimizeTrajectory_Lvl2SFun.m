function optimizeTrajectory_Lvl2SFun(block)
...
thrLength = block.InputPort(6).Data;
...
[F_t_mpc,sigF_t_mpc,skp1_kp1_mpc,ckp1_kp1_mpc] = ...
    mpckfgp.calcKalmanStateEstimates(sk_k,ck_k,xSamp,ySamp);
...
% get other values
[~,jExptFmin,jExpreFmin] = ...
    mpckfgp.calcMpcObjectiveFn(...
    F_t_mpc,sigF_t_mpc,skp1_kp1_mpc,ckp1_kp1_mpc,...
    bestTraj);
jExploitFmin = sum(jExptFmin);
jExploreFmin = sum(jExpreFmin);
