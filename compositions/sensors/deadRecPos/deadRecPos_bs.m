...
sns.ARW = SIM.parameter('Unit','deg/(s)^1/2','Value',0.24/60,'Description','Angle Random Walk');
...
sns.bGyro = SIM.parameter('Unit','','Value',5*3*ones(3,1)/3600,'Description','Static Gyro Bias');
...
sns.bAcc = SIM.parameter('Unit','','Value',5*0.02*9.81/1000*ones(3,1),'Description','Static Accelleration Bias');
sns.gndTruthFreq = SIM.parameter('Unit','rad/s','Value',pi/2,'Description','Update Frequency for acoustic ground truth');
sns.posErrMag = SIM.parameter('Unit','m','Value',5,'Description','Positional Accuracy of Acoustic Ping');
