...
elems(11).Name = 'tetherReleaseSpeeds';
elems(11).DimensionsMode = 'Fixed';
elems(11).Dimensions = [sz.numTethers 1];
...
elems(12).Name = 'gndTenVecs';
elems(12).Dimensions = sz.nodeTenVecSize;
...
elems(14).Name = 'rotorSpeed';
elems(14).Dimensions = [n 1];
