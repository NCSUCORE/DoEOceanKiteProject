    ...
    for i = 1:length(inc)
        ...
        for j = 1:length(towArray)
            ...
            for k = 1
                ...
                %%  Vehicle Properties
                vhcl.stbdWing.setGainCL(vhcl.stbdWing.gainCL.Value/6,'1/deg');
                vhcl.portWing.setGainCL(vhcl.portWing.gainCL.Value/6,'1/deg');
                vhcl.stbdWing.setGainCD(vhcl.stbdWing.gainCD.Value/6,'1/deg');
                vhcl.portWing.setGainCD(vhcl.portWing.gainCD.Value/6,'1/deg');
                if q == 3
                ...
                if q == 2
                    vhcl.animateSim(tsc1{i,j,k},0.2,'GifTimeStep',0.2,'SaveGif',1==1)%,'View',[0 0])
