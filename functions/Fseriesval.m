...
switch nargin
    case 3
        [n,x,scale,xrow] = checkinputs(a,b,x);
    case 4
        [n,x,scale,xrow] = checkinputs(a,b,x,scale);
    otherwise
        error('MATLAB:Fseriesval:TooManyInputs','Too many inputs')
end
...
function [n,x,scale,xrow] = checkinputs(a,b,x,scale)
% coefficients
